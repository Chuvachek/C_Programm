#include <stdio.h>
/*Эта программа считает длины отдельных участков. Можно использовать для подсчета длин стен, забора и т.д. Всго 15 участков (можно указать больше)*/
int main() {
